...
newtype AbbreviationNumber = AbbreviationNumber Int deriving Eq
...
newtype DictionaryBase = DictionaryBase Int
newtype DictionaryAddress =  DictionaryAddress Int
newtype DictionaryNumber = DictionaryNumber Int
newtype WordSeparatorNumber = WordSeparatorNumber Int